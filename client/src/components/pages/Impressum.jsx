  ...
  render() {
    return (
      <div className="Home" style={{ margin: 20, padding: 30 }}>
        ...
        <br/>Der Text ersetzt keinesfalls die fachliche Beratung durch einen Arzt oder Apotheker und er darf nicht als Grundlage zur eigenständigen Diagnose und Beginn, Änderung oder Beendigung einer Behandlung von Krankheiten verwendet werden. Konsultieren Sie bei gesundheitlichen Fragen oder Beschwerden immer den Arzt Ihres Vertrauens! Die Autoren übernehmen keine Haftung für Unannehmlichkeiten oder Schäden, die sich aus der Anwendung der Informationen ergeben.

        <br/><br/>Haftungsausschluss: 
